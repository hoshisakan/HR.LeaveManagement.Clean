...
namespace HR.LeaveManagement.Persistence.Configurations.Migrations
{
    ...
    [Migration("20260302074834_InitialMigration")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 3, 2, 15, 48, 33, 360, DateTimeKind.Local).AddTicks(5883),
                            DateModified = new DateTime(2026, 3, 2, 15, 48, 33, 360, DateTimeKind.Local).AddTicks(5915),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
