...
namespace HR.LeaveManagement.Persistence.Configurations.Migrations
{
    ...
    [Migration("20260317193636_AddUsedDaysToLeaveAllocation")]
    partial class AddUsedDaysToLeaveAllocation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 3, 18, 3, 36, 35, 412, DateTimeKind.Local).AddTicks(5838),
                            DateModified = new DateTime(2026, 3, 18, 3, 36, 35, 412, DateTimeKind.Local).AddTicks(5857),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
