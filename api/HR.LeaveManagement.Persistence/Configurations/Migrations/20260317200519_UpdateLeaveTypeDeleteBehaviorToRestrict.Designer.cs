...
namespace HR.LeaveManagement.Persistence.Configurations.Migrations
{
    ...
    [Migration("20260317200519_UpdateLeaveTypeDeleteBehaviorToRestrict")]
    partial class UpdateLeaveTypeDeleteBehaviorToRestrict
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2026, 3, 18, 4, 5, 18, 810, DateTimeKind.Local).AddTicks(3772),
                            DateModified = new DateTime(2026, 3, 18, 4, 5, 18, 810, DateTimeKind.Local).AddTicks(3788),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
